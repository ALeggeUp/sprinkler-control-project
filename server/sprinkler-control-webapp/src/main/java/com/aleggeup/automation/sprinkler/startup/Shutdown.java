...
public class Shutdown {
    ...
    @Inject
    public Shutdown(final AnalyticsService analyticsService, final QuartzSchedulerResources quartzSchedulerResources,
    ...
    public void shutdown() {
        analyticsService.end();
        quartzSchedulerResources.getThreadPool().shutdown(true);
        try {
